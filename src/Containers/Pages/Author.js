                ...
                <Grid item xs={12} sm={12} md={12} lg={12}>
                    <div className='starter'>
                        ...
                        <p className={classes.para}>
                            ...
                            در کادر علمی دیپارتمنت فلسفه و عقیدۀ فاکولتۀ شرعیات به گونۀ کاملاً مستقل به
                            تدریس فلسفه، منطق، متدولوژی و کلام اسلامی (عقاید اسلامی) پرداخت و تا سال
                        ...
                        <p className={classes.para}>
                            باتوجه به سیل مهاجرت استادان و فرهنگیان مؤسسات گوناگون دانشی-پژوهشی کابل به
                            بغلان، مهم‌ترین مشغلۀ محور فکری استاد کاوش بنیادگذاری دانش‌گاه بغلان بود.
                            بنابراین استاد کاوش به این مقصد پی‌هم جلساتی با الحاج سید منصور نادری رئیس
                            کانون فرهنگی حکیم ناصرخسرو بلخی برگزار و پس از رأی‌زنی‌های ممتد و اصرار و
                            ترغیب، بالاخره این پیشنهاد استاد کاوش مورد پذیرش قرارگرفت و در نتیجۀ آن،
                            ضرورت تأسیس دانش‌گاه بغلان نزد رهبری سیاسی-اداری ولایت بغلان مُسلّم و به
                            تأسی از آن تحقق این هدف به مقامات رهبری شمال مستقل موقتی کشور پیشنهاد و
                            منظور گردید. و بلافاصله استاد کاوش به حیث نخستین رئیس دانش‌گاه (پوهنتون)
                            بغلان مقرر و رهبری علمی و اداری این دانش‌گاه نوبنیاد را به هم‌کاری استادان
                            و دانش‌مندان مهاجرشده از کابل به بغلان بر دوش گرفت.
                        </p>
                        <p className={classes.para}>
                            ...
                            به‌موانع جدّی مواجه و عملا ناممکن گردید. از این ‌رو استاد کاوش که خود طابع
                    ...
                    <div className='purple'>
                            ...
                            <p className={classes.para}>
                                13- از 7 ثور تا 8 ثور/بررسی مشخصات سیاسی-فرهنگی روی‌داد‌های
                                1978-1998/1357-1377، افغانستان (چاپ‌ناشده)
                            </p>
                            <p className={classes.para}>
                    ...
                    <p className={classes.para}>
                        4- پژوهشی پیرامون شک متدیک غزالی اندیشمند بزرگ اسلامی، شمارۀ اول، سال اول،
                    ...
                    <p className={classes.para}>
                        6- گذری بر پیشینۀ علم‌پروری مسلمانان و نظری بر متدولوژی جابر بن حیٌان، جزو
                    ...
                    <p className={classes.para}>
                        ...
                        سال‌زاد ابوریحان بیرونی که از سوی دانش‌گاه کابل از 18-20 دسامبر 1991 دایر
                        گردید. مجلۀ حجت (نشریۀ کانون فرهنگی حکیم ناصرخسرو بلخی، شمارۀ 12 سال
                        1994/1373)
                    </p>
                    <p className={classes.para}>
                    ...
                    <p className={classes.para}>
                        12- سماع از دیدگاه شیخ نجم الدین کبری (به مناسبت سمپوزیم بین‌المللی هشتصد و
                        پنجاهمین سال‌زاد شیخ نجم الدین کبری در تاشکند)، شمارۀ 15، مجلۀ حجت
                    ...
                    <p className={classes.para}>
                        9- عضویت در شورای عالی پوهنتون علوم اسلامی افغانستان و نیز انجام خدمت به
                        حیث منشی آن شورا
                    </p>
                    <p className={classes.para}>
                    ...
                    <p className={classes.para}>
                        ...
                        ”انسان‌شناختی بیدل“- که تا کنون سه مجلد آن در ظرف 1818 صفحه به چاپ رسیده
                        است- قابل درک است.
                    </p>
                    <p className={classes.para}>
